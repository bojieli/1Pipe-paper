...
In addition, the reliable service ensures \emph{restricted failure atomicity}: either all or none messages in a batch are delivered unless a receiver fails or network partitions permanently after the messages are sent.
