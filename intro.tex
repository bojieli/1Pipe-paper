...
For example, a client updates metadata and data simultaneously in a distributed storage.
...
\emph{Reliability} means both (1) \emph{atomicity} or \emph{serializability}, i.e., either all or none receivers deliver messages in a scattering, and (2) \emph{validity}, i.e., a scattering is guaranteed to be delivered if its sender and all receivers are correct, and the network is not partitioned.
