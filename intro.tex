...
For example, multiple shards of a distributed database generate logs to multiple replicas. Each replica may receive logs from shards in a different order, making replicas inconsistent.%\textcolor{red}{describe side effects, e.g., violating data consistence}.
