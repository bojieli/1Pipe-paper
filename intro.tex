...
In addition, reliable \sys{} ensures \emph{restricted failure atomicity}: either all or none messages in a batch are delivered unless a receiver fails permanently or network partitions after the messages are sent.
...
Reliable \sys{} adds one network round-trip time (RTT) compared to best effort \sys{}.
