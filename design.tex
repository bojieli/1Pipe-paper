...
Best effort \sys{} provides total order, causal, and FIFO message delivery\revise{, but do not retransmit lost packets and do not provide atomicity}.
