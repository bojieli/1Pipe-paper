...
Logical time roughly increases at the same rate as the clock time, therefore, in practice, we represent logical time as local clock time \RED{nanosecond level, is specifying time unit here sufficient?} plus an offset, and track and adjust the offset instead.
