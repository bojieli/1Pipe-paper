...
\begin{equation*}
\begin{aligned}
T'_k & = \texttt{BackFunc} \{ \texttt{FwdFunc} \{ T_i | i \in \mathcal{S} \} + RTT_{kj} | j \in \mathcal{R} \}
\end{aligned}
\end{equation*}
