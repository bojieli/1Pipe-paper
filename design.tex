...
\sys leverages the \emph{barrier timestamp} to deliver order information. Before introducing the mechanims, we illustrate the barrier timestamp with a simple example.   
