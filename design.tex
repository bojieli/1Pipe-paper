...
However, this approach does not consider the delay variance of different network paths. Delay variance may be caused by different processing delays in OS kernel, different cable lengths and different queueing delay. 
