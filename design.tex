...
To \emph{reliably deliver} a message, all receipients in the same scattering group should have tentatively delivered the message.
...
Loss-free and ACK barriers is an optimization to reduce message delivery latency in the absence of packet loss.
...
In this section, we first handle crash failure of hosts, then extend it to handle Byzantine hosts, finally handle crash failure of network switches and links.
