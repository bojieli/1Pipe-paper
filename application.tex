...
As shown in Figure~\ref{fig:tpc-c}, lock and OCC do not scale beyond the number of warehouses, because each Payment transaction
updates its corresponding warehouse entry and each New-Order reads it
