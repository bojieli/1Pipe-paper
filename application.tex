...
\textbf{Need to update figure to multiply y by 2.}
...
\begin{figure*}[t]
    \begin{minipage}[t]{.66\textwidth}
    	...
    	\hspace{0.01\textwidth}
    	\subfloat[Resilience of packet loss.\label{fig:tpcc-payment}]
    	{\includegraphics[width=.49\textwidth]{gnuplot/tpcc-payment.eps}}
    	\vspace{-5pt}
    ...
    \begin{minipage}[t]{.32\textwidth}
        ...
        \vspace{-10pt}
    	\caption{Independent general TXN.}
