...
Compare latency and throughput of TOMS with network sequencer (control path) and centralized coordinator (data path). Just list some numbers in one paragraph. \RED{Bojie should fill in the numbers.}
