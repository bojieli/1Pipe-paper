...
\begin{figure*}[t!]
    ...
    \begin{minipage}{.31\textwidth}
		...
		\caption{Throughput of multiple keys per transaction. \RED{Y label, M  txn/s?}}
...
On the latency side, reliable \sys adds one RTT of latency to derive the commit barrier \RED{delivery barrier?}.
