...
Each recipient processes messages from all DAOs in timestamp order (ties are broken by the ID of initiator). So, the DAOs are sequentially consistent.
...
FaRMv2~\cite{shamis2020fast} leverage accurate global time for fast distributed transactions.}
