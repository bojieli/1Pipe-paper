...
In particular, x86 ensures a \textit{total store ordering} (TSO) memory model~\cite{sewell2010x86} \RED{where each core observes a consistent ordering of writes from all other cores}.
