...
\begin{tabular}{l}
	\hline
	\texttt{TS = onepipe\_send(vec[<dst, msg>])} \\
	\hline
	\hline
	\texttt{TS, vec[<src, msg>] = onepipe\_unreliable\_recv()} \\
	\hline
	\texttt{onepipe\_send\_fail\_callback(func(TS, dst, msg))} \\
	\hline
	\hline
	\texttt{TS, vec[<src, msg>] = onepipe\_reliable\_recv()} \\
	\hline
	\texttt{onepipe\_proc\_fail\_callback(func(proc, TS))} \\
	\hline
	\hline
	\texttt{TS = onepipe\_get\_timestamp()} \\
	\hline
	\texttt{onepipe\_init()} \\
	\hline
	\texttt{onepipe\_exit()} \\
