...
There has been extensive research on total order multicast and broadcast.
...
Causal communication can be efficiently implemented via cbcast~\cite{birman1987exploiting,birman1987reliable,birman1991lightweight,birman1984overview,birman1993process}, but it is insufficient for replication and transactional KVS because they need total order.

Critics~\cite{cheriton1994understanding} and proponents~\cite{birman1994response,van1994bother} of causal and totally ordered communication (CATOCS) have long discussed the pros and cons of such a primitive. 
...
NetChain~\cite{jin2018netchain}, NetLock~\cite{yu2020netlock}, NetPaxos~\cite{dang2015netpaxos}, and Daiet~\cite{sapio2017network} offloads important distributed middlewares to programmable switches.
Omnisequencing~\cite{michael2018towards} finds out that DCN topology can provide causal message delivery.
