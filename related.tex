...
\RED{Machine-aware Atomic Broadcast Trees for Multicores, OSDI'16.}
\RED{NetChain: Scale-Free Sub-RTT Coordination (key-value store + scalable)
Exploiting a Natural Network Effect for Scalable, Fine-grained Clock Synchronization (background for clock synchronization algorithm)}
\RED{PLOVER: Fast, Multi-core Scalable Virtual Machine Fault-tolerance (application of TOMS)}
