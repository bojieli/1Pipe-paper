...
Several mostly related works are discussed in Sec.\ref{subsec:existing-approaches}.

\parab{Tree-based total order.}Tree-based algorithms for total order communication address the trade-off between efficiency and scalability~\cite{rodrigues1998scalable}, which is used in multi-core processors~\cite{kaestle2016machine} and sensor networks~\cite{chakraborty2011reliable}.
