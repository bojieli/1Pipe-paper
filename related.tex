...
Critics of totally ordered communication~\cite{cheriton1994understanding} blame the lack of atomicity, limited scalability and violation of end-to-end principle. \sys provides atomicity with message scattering, achieves scalability with in-network computation and incurs little overhead.
