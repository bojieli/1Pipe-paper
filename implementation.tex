...
In future work, the software process of \textit{lib1pipe} may be offloaded to a programmable NIC~\cite{kaufmann2016high,firestone2018azure}, where the NIC assigns timestamps to messages on egress pipeline.
