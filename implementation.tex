...
The controller is a replicated service that stores network topology, process information, failure notifications, and undeliverable recall messages in etcd~\cite{etcd}.
