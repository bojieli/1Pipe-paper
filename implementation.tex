...
Compared with the previous approach, this approach slacks the barriers in two aspects.
...
%Compared to Sec.~\ref{sec:commodity}, the additional reordering delay is host-to-switch RTT $\times$ number of hops.
