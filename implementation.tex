...
Compared with the \revise{programmable} chip, switch CPU slacks the barriers because 1) CPU processing has delay and 2) the barriers are updated by periodical beacons instead of by every packet.
