...
\parab{Scalable throughput.}\sys achieves throughput close to underlying hardware limit, and scales linearly to 1K hosts.
...
\parab{Scalability of total ordering.}\label{subsubsec:scalability}
