...
\RED{Compare with optimized Lamport timestamp where received timestamps are exchanged per interval. Optimized Lamport timestamp has a trade-off between latency and throughput. e.g. use 10\% throughput for timestamp exchange: 0.8M msg/s, 512 processes, 1.5K msg/s, interval = 1/1.5K = 700 us.}
