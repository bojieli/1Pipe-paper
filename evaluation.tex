...
Figure X compares the throughput with hierarchical merge using end hosts only.

Figure X shows the reordering delay with background traffic. 

Figure X compares reordering delay of minimax clock synchronization with physical clock synchronization.
