...
We prove the correctness and liveness of \sys in Appendix~\ref{appx:proof}. We summarize the key findings as follows:
...
\parab{Low network and CPU overhead.}\sys's beacon traffic only consumes 0.1\% link capacity. At switches, beacon packets can be processed by a CPU core. At hosts, reordering computation consumes less than 10\% of a core.
