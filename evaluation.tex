...
Reordering delay is the interval from message arrival to delivery. 

Using end host representatives to process beacons introduces extra forwarding delay from the switch to the end host representative.
As the number of network layers increases, the reordering delay also increases, due to per-hop beacon processing delay.
