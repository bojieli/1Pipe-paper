...
In Figure~\ref{fig:reorder-loss}, we simulate random message drop in \textit{lib1pipe} sender and receiver to evaluate how packet loss affects latency in the testbed with 512 processes.
