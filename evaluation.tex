...
\centering
\subfloat[Throughput]{
	\includegraphics[width=.24\textwidth]{gnuplot/total_order.eps}
}
\subfloat[Latency]{
	\includegraphics[width=.24\textwidth]{gnuplot/total_order_lat.eps}
}
...
The throughput is mainly bottlenecked by CPU processing and RDMA messaging rate.
...
In timestamp-based ordering, a receiver waits for timestamps from  other receivers, introducing delay as well as network overhead.
...
\begin{figure}[t]
	...
	\begin{minipage}[t]{.23\textwidth}
		\centering
		\includegraphics[width=\textwidth]{images/fixme.pdf}
