...
Reordering delay is the interval from message arrival to delivery. Using end host representatives to process beacons introduces additional delay due to forwarding delay from the switch to the end host representatives.
