...
We propose a causal and total order communication abstraction, \sys{}, that delivers messages in sender's clock time order with \revise{restricted} failure atomicity. 
...
%transactional key-value stores, independent transactions, distributed data structures, and log replication.
