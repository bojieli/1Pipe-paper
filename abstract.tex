...
Evaluation on a 32-server testbed shows that \sys achieves scalable throughput and low latency with negligible CPU and network overheads.
As a case study, \sys{} achieves linearly scalable throughput and consistently low latency in transactional key-value store and TPC-C that outperforms traditional design by 2-20x, as well accelerating remote data structures.
