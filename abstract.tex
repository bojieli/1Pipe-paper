...
\sys{} achieves linearly scalable throughput and consistent low latency in transactional key-value store and TPC-C that outperforms traditional design by 2-20x, as well accelerating remote data structures.
