...
We build two ROMS prototypes using Barefoot and Arista switches.
Our evaluation shows that ROMS achieves high performance and fault tolerance with low CPU and network overheads.
As a case study, ROMS achieves externally consistent independent transactions with latency and throughput close to a non-transactional, non-replicated system.
Compared to MVCC and Paxos-based replication, ROMS improves throughput by up to 50x for YCSB+T and 100x for TPC-C Payment transactions.
