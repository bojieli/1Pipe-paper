...
\sys{} provides a best effort service that delivers each message at most once in $\sim$0.5 RTT, and a reliable service that provides restricted atomic delivery for each scattering in $\sim$1.5 RTTs.
