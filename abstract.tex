...
\sys{} can simplify and accelerate many distributed applications, e.g., transactional key-value stores, log replication, and distributed data structures.
...
As a case study, compared to locking, \sys improves throughput by up to 50x for a transactional key-value store, and up to 100x for TPC-C Payment transactions.
