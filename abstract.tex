...
In this paper, we propose Total-Order Message Scattering (\sys), an efficient and scalable method to scatter groups of messages in total order via data center network.
...
We implement two \sys prototypes using P4 programmable switches and commodity switches.\textcolor{red}{Barefoot reconfigurable switch and Arista fixed-function switch}
