...
%If network partition occurs, only one partition may connect to the controller, and the controller will announce failure of all processes in other network partitions.
